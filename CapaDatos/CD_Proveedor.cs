...
namespace CapaDatos
{
    public class CD_Proveedor
    {
        ...
        public bool ValidarProveedor(string Nombre)
        {
            ...
            try
            {
                Conexion.SetConsutar("SELECT COUNT(*) FROM Proveedor WHERE razon_social = @Nombre");
        ...
        public bool ValidarProveedorTelf(string Telefono)
        {
            ...
            try
            {
                Conexion.SetConsutar("SELECT COUNT(*) FROM Proveedor WHERE Telefono = @Telefono");
                Conexion.SetearParametro("@Telefono", Telefono);
